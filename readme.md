...
- **工具一：可视化诊断模式**
  ...
  <img src="images/调试模式.png" alt="右键开启诊断模式" style="max-width:400px; width:100%;"/>

- **工具二：一键打开日志**
  除了可视化的红框，我还添加了"打开日志"按钮。用户可一键找到包含了程序关键运行节点和状态的日志文件，方便发送，为我深度分析提供依据。

  <!-- markdownlint-disable-next-line MD033 -->
  <img src="images/内置日志打印.png" alt="一键打开日志文件" style="max-width:700px; width:100%;"/>
...
<!-- markdownlint-disable-next-line MD033 -->
<img src="images/用户反馈图片.png" alt="用户在带鱼屏下开启诊断模式的反馈截图" style="max-width:600px; width:100%;"/>
